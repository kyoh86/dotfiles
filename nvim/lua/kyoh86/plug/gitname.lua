...
local spec = {
  ...
  init = function()
    ...
    vim.api.nvim_create_user_command("YankGitHubURL", func.bind(vim.fn["gitname#yank#hub_url"], "branch"), { range = true, bang = true })
    vim.api.nvim_create_user_command("YankGitHubPermanentURL", func.bind(vim.fn["gitname#yank#hub_url"], "head"), { range = true, bang = true })
